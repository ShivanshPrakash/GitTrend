...
class RepoAdapter(private val repositoryList: List<Repository>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        RepositoryViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_repo_item, parent, false))
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (repository.languageColor != null)
            ((repoViewHolder.langColorIndicator.background) as GradientDrawable).setColor(Color.parseColor(repository.languageColor))
